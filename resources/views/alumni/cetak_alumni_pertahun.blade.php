...
<html lang="en">
    ...
    <body>
        <div class="form-group">
            <h3 align="center"><img src="{{asset('Gambar/logo.png')}}" alt="" class="brand-image img-circle" style="opacity: .9" width="50px" height="50px"><br><b>Data Alumni Pertahun</b></h3>
            <table class="static" align="center" rules="all" style="width: 95%;">
                ...
                @foreach ($cetak_alumni_pertahun as $item)
                <tr>
